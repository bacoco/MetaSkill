#!/usr/bin/env python3
"""
SOUL data reader for NEXUS pattern detection
"""
...
class SOULDataReader:
    """Reads and parses SOUL files"""
    ...
    def __init__(self, repo_root: str, config: ConfigManager):
        ...
        # SOUL file paths
        self.agent_log_path = self.repo_root / ".agent_log.md"
        self.agent_status_path = self.repo_root / ".agent_status.json"
        self.agent_handoff_path = self.repo_root / ".agent_handoff.md"

    def read_all_soul_data(self) -> Dict:
        """Read all SOUL files and return structured data"""
        data = {
            "sessions": [],
            "current_status": {},
            "handoff_info": {},
        ...
        try:
            ...
            self.logger.error(f"Error reading SOUL data: {e}")

        return data

    def parse_agent_log(self) -> List[SessionData]:
        """Parse .agent_log.md into structured session data"""
        sessions = []
