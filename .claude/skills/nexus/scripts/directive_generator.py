#!/usr/bin/env python3
"""
NEXUS Directive Generator
Creates skill creation directives from pattern analysis.

Instead of generating full skills, NEXUS creates markdown directive files
that guide Claude to create appropriate skills using its native capabilities.

Generated by NEXUS - Directive Generation Engine
"""
...
**Generated by NEXUS** on {self.timestamp}
...
"""
        ...
        if example_use_cases:
            directive += f"""
### Real Usage Examples from SOUL Data
...
- Decreased mentions of {skill_type} problems in SOUL logs
...
"""
    ...
    def create_index_file(self, directive_files: List[Path]):
        ...
        index_content = f"""# NEXUS Skill Directives Index
...
description: {description} Automatically created by NEXUS from detected patterns.
---
...
"""
        ...
        content += f"""
---
*Generated by NEXUS based on your actual usage patterns*
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="NEXUS Directive Generator - Create skill creation guidance from pattern analysis",
